    ...
    <footer className="py-10 border-t border-white/[0.04]" style={{ background: '#020609' }}>
      <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <a href={profile.malt} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-orange-400 transition-colors text-xs glass px-3 py-1.5 rounded-full">Malt</a>
        </div>
      </div>
    </footer>
  );
